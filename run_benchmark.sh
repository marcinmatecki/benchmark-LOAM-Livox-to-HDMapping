...
# run_benchmark.sh - Reusable benchmark runner for LOAM-Livox (ROS1)
set -e
...
echo "=========================================="
echo "Running LOAM-Livox benchmark (ROS1)"
...
IMAGE="${LOAMLIVOX_IMAGE:-ghcr.io/mapshd/loamlivox2hdmapping:latest}"
...
docker run --rm -t \
    ...
    bash -lc "
      ...
      roslaunch ${LOAMLIVOX_LAUNCH} >/tmp/loamlivox.log 2>&1 &
      LAUNCH_PID=\$!
      ...
      rosrun loam-to-hdmapping listener \"\${REC_BAG}\" \"\${OUT_DIR}/hdmapping\"
    "
